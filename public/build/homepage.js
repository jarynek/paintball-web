...
/** @class */
function () {
  function Homepage(name, jsCore, orderService) {
    this.jsCore = jsCore;
  ...
  Homepage.prototype._sendForm = function () {
...
new Homepage('jarek', new _jsCore__WEBPACK_IMPORTED_MODULE_1__["JsCore"](), new _services_OrderService__WEBPACK_IMPORTED_MODULE_0__["OrderService"]('jarek'));
...
function () {
  ...
  OrderService.prototype.checkFormData = function (form) {
    ...
    $(form).find('input[data-check]').on('keyup blur', function (event) {
      ...
      var checkStatue = Object.values(_this.orderForm).filter(function (item) {
  ...
  OrderService.prototype._init = function () {
    this.orderForm = [{
      name: 'name',
      check: false
    }, {
