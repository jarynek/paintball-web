...
/***/ "./assets/ts/homepage.ts":
/*!*******************************!*\
  !*** ./assets/ts/homepage.ts ***!
  \*******************************/
/*! exports provided: orderForm, Homepage */
...
/* harmony import */ var _services_OrderService__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./services/OrderService */ "./assets/ts/services/OrderService.ts");
/* harmony import */ var _jsCore__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../jsCore */ "./jsCore.ts");
...
function () {
  function Homepage(name, orderForm, jsCore, orderService) {
    ...
    var foo = null;
    var x = foo !== null && foo !== void 0 ? foo : 'jarek';
    console.log(x);
  }
  /**
  ...
  _createClass(Homepage, [{
    key: "toggleSelection",
    value: function toggleSelection(event) {
...
new Homepage('jarek', orderForm, new _jsCore__WEBPACK_IMPORTED_MODULE_1__["JsCore"](), new _services_OrderService__WEBPACK_IMPORTED_MODULE_0__["OrderService"]('jarek', orderForm));

/***/ }),

/***/ "./assets/ts/services/OrderService.ts":
/*!********************************************!*\
  !*** ./assets/ts/services/OrderService.ts ***!
  \********************************************/
...
function () {
  ...
  _createClass(OrderService, [{
    key: "checkFormData",
    value: function checkFormData(form) {
      var _this = this;
      ...
      $(form).find('input[data-check]').on('keyup blur', function (event) {
        ...
        var checkStatus = Object.values(_this.orderForm).filter(function (item) {
    ...
    key: "checkDateTime",
    value: function checkDateTime(dp, $input) {
      var compareId = $input.attr('id') === 'date_time_from' ? 'date_time_to' : 'date_time_from';
      var compareInput = $("#".concat(compareId));
      ...
      var orderFormDate = this.orderForm.find(function (item) {
      ...
      this.orderForm.find(function (item) {
        return item.name === 'date' ? Object.assign(item, orderFormDate) : item;
      });
    }
  }, {
    key: "checkFill",
    value: function checkFill(el) {
...
/*!*******************!*\
  !*** ./jsCore.ts ***!
  \*******************/
/*! exports provided: JsCore */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JsCore", function() { return JsCore; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function () {
  ...
  _createClass(JsCore, [{
    ...
    key: "dateTimePicker",
    value: function dateTimePicker(callBackFn) {
